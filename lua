...
-- ═══════════════════════════════════════════════════════════════
-- ⛏️ PICKAXE SIMULATOR - SIMPLE MODE (NO HOOKS!)
-- استثناء خاص: يشتغل قبل أي فحوصات
-- ═══════════════════════════════════════════════════════════════
if _pid == _PD then
    -- Simple clean script (no anti-cheat triggers)
    do
